...
*   **`ai_usage_logs`**: Tracks local vs AI processing to monitor cost savings.
*   **`learned_ocr_patterns`**: Database of successful AI OCR results used to train local pattern matching.
