 ...
 * 
 * Legal terms and conditions for FitnessFlow SaaS platform.
        ...
        <article className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground-secondary leading-relaxed mb-4">
              By accessing and using FitnessFlow ("the Service"), you accept and agree to be bound by the terms 
              and provision of this agreement. If you do not agree to these Terms of Service, please do not use 
              our Service.
            </p>
            <p className="text-foreground-secondary leading-relaxed">
              FitnessFlow is a Software-as-a-Service (SaaS) platform designed for fitness professionals, 
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground-secondary leading-relaxed mb-4">
              FitnessFlow operates on a subscription model. Subscription fees are billed monthly or annually 
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground-secondary leading-relaxed mb-4">
              ...
              and content, is owned by FitnessFlow and protected by intellectual property laws. 
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground-secondary leading-relaxed mb-4">
              <strong>IMPORTANT:</strong> FitnessFlow is a tool for fitness professionals and is not a 
            ...
            <p className="text-foreground-secondary leading-relaxed mb-4">
              To the maximum extent permitted by law, FitnessFlow shall not be liable for any indirect, 
            ...
            <p className="text-foreground-secondary leading-relaxed">
              FitnessFlow makes no warranty that AI-generated analysis will be error-free, complete, or suitable 
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground-secondary leading-relaxed">
              ...
              Email: support@fitnessflow.com<br />
