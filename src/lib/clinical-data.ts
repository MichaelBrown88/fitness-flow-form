...
export const LIFESTYLE_FEEDBACK_DB: LifestyleAdvice[] = [
  { category: 'Sleep', scoreRange: 'less-than-7', riskLevel: 'High Risk', adviceBlock: 'Shortchanging sleep increases risks for high blood pressure, heart disease, weight gain, and reduced immunity. Prioritise a consistent sleep-wake schedule and turn off electronic devices at least 60 minutes before bedtime to allow melatonin production.' },
  { category: 'Sleep', scoreRange: '7-9', riskLevel: 'Optimal', adviceBlock: 'You are meeting the landmark guidelines for recovery. This duration supports cognitive function, metabolic health, and muscle protein synthesis. Maintain a cool bedroom temperature between 60 and 67 degrees to ensure high sleep quality.' },
  { category: 'Sleep', scoreRange: 'more-than-9', riskLevel: 'Optimal', adviceBlock: 'You are getting more than 9 hours of sleep. While generally positive for recovery, excessive sleep can sometimes indicate low sleep quality or other underlying factors. Ensure your sleep environment is optimal for deep recovery.' },
  { category: 'Stress', scoreRange: '27-40 (PSS)', riskLevel: 'High Risk', adviceBlock: 'Your perceived stress levels indicate a high risk for burnout and injury. High cortisol levels compete with anabolic hormones and sap lifting energy. Transition training to restorative sessions and prioritise mobility and sleep until scores improve.' },
