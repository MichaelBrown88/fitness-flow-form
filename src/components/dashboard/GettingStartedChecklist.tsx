...
export function GettingStartedChecklist({
  ...
  return (
    ...
    >
      ...
      >
        <ListChecks className="h-5 w-5 text-foreground-secondary shrink-0" aria-hidden />
        <span className="text-sm font-semibold text-foreground">{GETTING_STARTED.FAB_LABEL}</span>
        <span className="rounded-full bg-muted px-2 py-0.5 text-xs font-bold tabular-nums text-foreground-secondary">
