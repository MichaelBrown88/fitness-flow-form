      ...
      <div className="mb-6 md:mb-8">
        {!hideHeader && (
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 mb-2 sm:mb-3 md:mb-4 lg:mb-5 xl:mb-6">
            ...
            <h3 className="text-xs md:text-sm lg:text-base font-semibold text-zinc-900">Your Timeline</h3>
          </div>
        )}
        ...
        <Card className="p-4 sm:p-5 md:p-6 rounded-2xl overflow-hidden relative">
          ...
          <div className="mb-4 sm:mb-5">
            <h4 className="text-sm font-bold text-zinc-900 mb-1">Time to Goal</h4>
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-4 sm:gap-8 md:gap-10 lg:gap-12 w-full min-w-0">
          ...
          <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-4 md:gap-5 w-full min-w-0">
            {[
              ...
              <div key={i} className="flex flex-row items-start gap-3 sm:gap-4 p-3 sm:p-5 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-white/10 transition-all duration-300 group min-w-0 text-left">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xs sm:text-xs text-zinc-400 leading-relaxed group-hover:text-zinc-300 break-words">{item.desc}</div>
                </div>
              </div>
            ))}
          </div>
