    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {revenueByRegion.byRegion.GB && (
              <div className="rounded-xl border border-admin-border/80 bg-admin-surface-inset p-4">
                <p className="mb-1 text-xs text-admin-fg-muted">UK</p>
            ...
            {revenueByRegion.byRegion.US && (
              <div className="rounded-xl border border-admin-border/80 bg-admin-surface-inset p-4">
                <p className="mb-1 text-xs text-admin-fg-muted">US</p>
            ...
            {revenueByRegion.byRegion.KW && (
              <div className="rounded-xl border border-admin-border/80 bg-admin-surface-inset p-4">
                <p className="mb-1 text-xs text-admin-fg-muted">Kuwait</p>
                <p className="text-xl font-bold text-white">{formatCurrency(revenueByRegion.byRegion.KW.amountLocal, 'KWD')}</p>
              </div>
            )}
            <div className="rounded-xl border border-emerald-500/35 bg-admin-surface-inset p-4">
      ...
      <div className="rounded-2xl border border-admin-border bg-admin-card/80 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="rounded-xl border border-admin-border/80 bg-admin-surface-inset p-4">
            <p className="mb-1 text-xs text-admin-fg-muted">Monthly Recurring Revenue (GBP)</p>
            <p className="text-2xl font-bold text-white">{formatCurrency(metrics?.mrrCents ?? 0, 'GBP')}</p>
          </div>
          <div className="rounded-xl border border-admin-border/80 bg-admin-surface-inset p-4">
            <p className="mb-1 text-xs text-admin-fg-muted">Annual Recurring Revenue (GBP)</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-admin-border bg-admin-card/80 p-6">
          <p className="mb-1 text-xs text-admin-fg-muted">AI Costs (MTD)</p>
          <p className="text-2xl font-bold text-amber-400">{formatCurrency(metrics?.aiCostsMtdCents ?? 0, 'GBP')}</p>
        </div>
        <div className="rounded-2xl border border-admin-border bg-admin-card/80 p-6">
          <p className="mb-1 text-xs text-admin-fg-muted">AI Costs (All Time)</p>
