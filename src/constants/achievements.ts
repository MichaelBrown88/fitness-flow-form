...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  // ── Milestones (score-based) ──
  {
    ...
    category: 'progress',
    title: 'Breaking 60',
    description: 'AXIS Score™ reaches 60',
    icon: 'TrendingUp',
    threshold: 60,
  },
  {
    ...
    category: 'progress',
    title: 'Breaking 70',
    description: 'AXIS Score™ reaches 70',
    icon: 'TrendingUp',
    threshold: 70,
  },
  {
    ...
    category: 'progress',
    title: 'Breaking 80',
    description: 'AXIS Score™ reaches 80',
    icon: 'Zap',
    threshold: 80,
  },
  {
    ...
    category: 'progress',
    title: 'Breaking 90',
    description: 'AXIS Score™ reaches 90',
    icon: 'Star',
    threshold: 90,
  },
  ...
  },
  {
    ...
    category: 'progress',
    title: 'Biggest Leap',
    description: 'Single-assessment jump of 10+ points on your AXIS Score™',
    icon: 'Rocket',
    threshold: 10,
  },
  {
