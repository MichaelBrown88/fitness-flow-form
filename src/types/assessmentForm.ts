...
/**
 * Deep-cloned empty assessment form for tests and non-React fixtures.
 * Keeps nested arrays/objects isolated from the provider's canonical `initialFormData`.
 */
export function createEmptyAssessmentForm(): FormData {
