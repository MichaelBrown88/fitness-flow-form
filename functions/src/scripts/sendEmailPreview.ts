...
async function main(): Promise<void> {
  ...
  jobs.push({
    ...
    ...renderEducationEmail({
      ...
      bullets: [
        'Use client roadmaps to show progress in one view.',
        'Share the client report link so they see scores between sessions.',
        'Re-run pillars when retest dates hit — reminders surface in the dashboard.',
      ],
  ...
  jobs.push({
    ...
    ...renderNotificationEmail({
      subject: subjectReport,
      preheader: 'Jamie Client assessment report is ready to view.',
      appName: APP_NAME,
      summary: 'Jamie Client assessment report is ready to view.',
      linkHref: reportLink,
  ...
  jobs.push({
    ...
    ...renderActivationEmail({
      ...
      paragraphs: [
        'You’ve saved an assessment for Jamie Client. That’s a major step toward clearer client roadmaps and less assessment admin.',
